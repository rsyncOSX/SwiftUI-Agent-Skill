...
For chart accessibility (VoiceOver, Audio Graph, `AXChartDescriptorRepresentable`), complete examples, fallback strategies, WWDC sessions, and a full summary checklist, see `charts-accessibility.md`.
